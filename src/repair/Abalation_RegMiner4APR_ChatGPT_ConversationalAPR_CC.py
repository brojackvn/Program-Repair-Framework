...
class Abalation_RegMiner4APR_ChatGPT_ConversationalAPR_CC(AbstractRepair):
    ...
    def _format_prompt(self, buggy_function: str, failedMessage: str, bug_inducing_changes: str, changed_files: list) -> list:
        system_prompt = "You are an expert Automatic Program Repair Tool specialized in fixing Java regression bugs."
...
## Instructions
Please think step by step to identify the root cause based on the bug-inducing commit message and their relationship to regression fixing patches. Provide the correct function.
"""
            messages = [
