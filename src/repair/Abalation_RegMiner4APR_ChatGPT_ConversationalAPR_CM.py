...
class Abalation_RegMiner4APR_ChatGPT_ConversationalAPR_CM(AbstractRepair):
    ...
    def _load_arguments(self, args):
        ...
        self.output_dir = os.path.join(args.output_dir, "conversational-apr-cm", self.dataset_name, self.model_name, self.data_id)
    ...
    def repair(self):
        ...
        for attempt in range(self.attempts):
            ...
            experiment_name = f"conversational-APR-CM_{self.model_name}_{self.dataset_name}_{self.data_id}_attempt-{attempt+1}-{self.attempts}_{self.marking_time}" # Name of the experiment
            ...
            for iteration in range(self.iterations):
                ...
                if iteration == 0:
                    messages = self._format_prompt(bug_info["buggy_function"], formatted_failed_message, bug_info["bic_commit_message"])
                else:
    ...
    # ================== FORMATTING QUERY ==================
    def _format_prompt(self, buggy_function: str, failedMessage: str, bic_commit_message: str) -> list:
