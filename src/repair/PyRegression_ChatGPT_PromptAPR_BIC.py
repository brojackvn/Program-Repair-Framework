...
class PyRegression_ChatGPT_PromptAPR_BIC(AbstractRepair):
    ...
    def _load_arguments(self, args):
        ...
        self.experiment_name = f"promptAPR-BIC_{self.model_name}_{self.dataset_name}_{self.data_id}_{self.samples}_{timestamp}"
        self.output_dir = os.path.join(args.output_dir, "prompt-apr-bic", self.dataset_name, self.model_name, self.data_id)
