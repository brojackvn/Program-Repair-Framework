...
# BUG_ID=(1 2 3 5 10 12 13 17 21 22 25 28 30 31 33 34 35 36 37 38 39 40 41 24)
# BUG_ID=(42 43 44 46 47 48 52 54 55 56 63 65 66 72 74 75 76 77 81 82 84 95 73)
# BUG_ID=(4 11 15 16 18 26 50 59 62 64 69 70 71 78 83 85 94 99 4)
...
do
    ...
    python3 -m src.main conversational-apr-with-bic \
        ...
        --output-dir /external_disk/coding_space/ChatRepairRegression/experiments/ablation-output \
