...
# BUG_ID=(100 101 103 104 105 106 107 108 109 111 112 113 114 115 117 118 120 121 122 123 124)
...
JAVA11_IDS=(100 110 144 145 147)
...
do
    ...
    python3 -m src.main conversational-apr \
        ...
        --output-dir /external_disk/coding_space/ChatRepairRegression/experiments/output_test \
